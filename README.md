...
1. **Clone the repository**
   ```bash
   git clone https://github.com/mnhashemabadi/nogital-focus.git
   cd nogital-focus
   ```
...
📧 [LinkedIn](https://linkedin.com/in/mnhashemabadi)  
...
- **Issues**: [GitHub Issues](https://github.com/mnhashemabadi/nogital-focus/issues)
